package student_aleksejs_ivanovs.homework.lesson_9.level_1.task_2;
...
class Rocket {
    //Need to use the 'default' access operator, that is, do not write anything before the class
}
